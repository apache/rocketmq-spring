 ...
 * org.apache.rocketmq.spring.core.RocketMQLocalRequestCallback, which will be wrapped to
 * org.apache.rocketmq.client.producer.RequestCallback later. The class implements
 * two methods for process callback events after receiving reply messages from consumers.
...
@Documented
@Component
public @interface RocketMQRequestCallbackListener {
